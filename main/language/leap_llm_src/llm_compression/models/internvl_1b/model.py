...
class InternLM2Model(nn.Module):
    """LLM text model for InternVL2-1B / InternVL2.5-1B (Qwen2-style backbone).

    Key differences from Qwen3Model (InternVL3.5):
    - Uses decoder layers with q/k/v bias=True and o_proj bias=False
    - No q_norm/k_norm
    - Uses standard 1D RoPE with rope_theta=1000000
    """
