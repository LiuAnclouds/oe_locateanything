...
class InternLM2DecoderLayer(nn.Module):
    """Decoder layer for the InternVL2-1B / InternVL2.5-1B text backbone.

    Differences from Qwen3DecoderLayer:
    - Uses attention with q/k/v bias and no q_norm/k_norm
    - Uses InternLM2MLP (same SwiGLU structure)
    """
