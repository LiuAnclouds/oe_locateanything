...
class InternAttention(nn.Module):
    """Vision encoder attention — split q/k/v proj, pre-scale (aligned with leap_llm)."""
...
class InternLM2Attention(nn.Module):
    """LLM decoder attention for InternVL 2B (InternLM2 backbone).

    - q/k/v proj bias=False (InternLM2 fused wqkv without bias)
    - o_proj bias=False
    - No q_norm/k_norm
    - head_dim=128
    """
    ...
    def __init__(self, config, layer_idx):
        ...
        # InternLM2: q/k/v bias=False, o_proj bias=False
