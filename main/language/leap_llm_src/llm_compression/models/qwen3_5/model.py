...
from .blocks.attention import Qwen3_5RMSNorm
from .blocks.transformer_block import Qwen3_5DecoderLayer
from .blocks.vision_block import Qwen3_5VisionBlock
from .blocks.vision_patch import Qwen3_5VisionPatchEmbed, Qwen3_5VisionPatchMerger
...
class Qwen3_5TextRotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        ...
        inv_freq_expanded = inv_freq[None, None, :, None].expand(3, position_ids.shape[1], -1, 1).float()
