...
class Eagle3Attention(Module):
    """EAGLE3 draft model attention.

    Key differences from Qwen3 Attention:
    - QKV input dimension is hidden_size * 2 (after concat of emb + hidden)
    - No q_norm / k_norm (LLaMA-style, not Qwen3-style)
    - Standard LLaMA rotary embeddings
    """
    ...
    def __init__(self, config):
        ...
        attn_input_size = self.hidden_size * 2
