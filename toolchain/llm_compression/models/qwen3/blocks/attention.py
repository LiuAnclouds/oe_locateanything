...
class Qwen3Attention(nn.Module):
    def __init__(self, config, layer_idx):
        ...
        if AttentionManager.is_flash_attn():
            ...
            logger.info(f"Using flash attention with block size {AttentionManager.get_flash_block_size()}")
    ...
    def forward(
        ...
        new_key = key_states  # [bsz, num_kv_heads, q_len, head_dim]
        new_value = value_states  # [bsz, num_kv_heads, q_len, head_dim]
