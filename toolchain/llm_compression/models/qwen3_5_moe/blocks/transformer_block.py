...
class Qwen3_5MoeDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.layer_type == "linear_attention":
            ...
            # Pass through unused KV-cache slots so every output is a tensor.
            # layer_type is static, so this branch is folded at trace time and
            # these passthroughs become dead code for the full-attn subgraph.
            new_key = cache_key
            ...
            # Pass through unused linear-attn state slots for the same reason.
