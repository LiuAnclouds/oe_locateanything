...
class Qwen3VLVisionPatchEmbed(nn.Module):
    """
    Patch embedding using a Linear layer (flattened Conv3d weights).
    Input: (seq_len, flatten_size) where flatten_size = temporal * patch * patch * in_channels
    """
...
class Qwen3VLVisionPatchMerger(nn.Module):
    """
    Merges spatial patches: norm -> reshape -> linear_fc1 -> GELU -> linear_fc2.
